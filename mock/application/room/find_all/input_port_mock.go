...
// Source: application/room/find_all/input_port.go
...
import (
	...
	room "github.com/karamaru-alpha/chat-go-server/application/room/find_all"
)
...
func (m *MockIInputPort) Handle() room.OutputData {
	m.ctrl.T.Helper()
...
func (mr *MockIInputPortMockRecorder) Handle() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Handle", reflect.TypeOf((*MockIInputPort)(nil).Handle))
}
